...
<div id="content">
    ...
    <form name="ec-influencer-product-register" id="ec-influencer-product-register" method="POST" action="gupdate.go" enctype="multipart/form-data">
		    ...
		    <div class="mBoard typeWrite">
		        <table border="1" summary="">
		            ...
		            <tr>
		                ...
		                <th scope="row">상품명 <strong class="icoRequired">필수</strong>
		                <input type="hidden" name="goodsId" value="${ g.goodsId }">
		                </th>
		                <td colspan="2">
		                    <div class="overlapTip ec-product-auto-translate">
		                        <span class="mFormRequired"><input type="text" value="${ g.goodsTitle }" name="goodsTitle" required="required" id="product_name"  class="fText eHasModifyProductAuth eMarketChecker" style="width:500px;"maxcount="250" >
		            ...
		            <tr>
		                ...
		                <td colspan="2">
		                    ...
		                    <span class="mFormRequired"><input type="text" value="${ g.goodsPrice }" class="fText right ePrdPrice eHasModifyProductAuth eMarketChecker ec-product-register-form-basic-price" name="goodsPrice" style="width:150px;"  required="required"><span class="requiredMsg gRightArrow">입력해주세요.
		            ...
		            <tr>
		                ...
		                <td colspan="2">
		                    <input type="text" value="${ g.goodsCompany }" class="fText" style="width:150px;" name="goodsCompany" id="ma_product_code"  maxcount="40">
		            ...
		            <tr>
		                ...
		                <td colspan="2" class="ec-product-auto-translate">
		                    <input type="text" value="${ g.goodsStock }" name="goodsStock" class="fText eMarketChecker" style="width:80%;"  maxcount="10" required="required">
		            ...
		            <tr>
		                ...
		                <td colspan="2">
		                    ...
		                    <input type="text" name="goodsSort" value="${ g.goodsSort }" class="fText eMarketChecker" style="width:80%;"  maxcount="10" required="required">
	                                ...
	                                <ul>
	                                    ...
	                                    <li>
	                                        <span class="item"><strong class="txtEm">썸네일</strong>이미지 
	                                            ...
	                                            <div id="file1">
	                                            	<input type="file" name="uploadFiles1" id="uploadFiles1" value="${ uploadFile1 }" class="btnAdd ec-product-register-image-upload-btn" style="cursor: pointer;" accept="image/*" required="required;">
	                                            	<input type="hidden" name="fileNo1" value="${ thumbFileNo }">
	                                            </div>
	                                    ...
	                                    <li>
	                                        <span class="item"><strong class="txtEm">상세</strong>이미지 <div class="cTip eSmartMode" code="PT.PE.690"><div class="mTooltip gLarge">
	                                            ...
	                                            <div id="file2">
	                                            	<input type="file" name="uploadFiles2" id="uploadFiles2" value="${ uploadFile2 }" class="btnAdd ec-product-register-image-upload-btn" style="cursor: pointer;" accept="image/*" required="required;">
	                                         		<input type="hidden" name="fileNo2" value="${ detailFileNo }">
	...
	<button class="btnSubmit" id="ec-product-register-submit">수정하기</button>
	</div>
