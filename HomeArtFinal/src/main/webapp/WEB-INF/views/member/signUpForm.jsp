   ...
   <div class="bodyWrap">
      ...
      <div class="container">
         ...
         <div class="containerBox">
            ...
            <form method="post"  action="signUp.me" encType="multipart/form-data" onsubmit="return signGo();">
               <div class="context" id="context">
                     ...
                     <tbody>
                        <tr> 
                           <td>
                              ...
                              <div class="checkText checkNickname" id="checkNickname">입력하지 않을시 유저이름이 닉네임으로 사용됩니다.</div>
                        ...
                        <tr>
                           <td>
                              ...
                              <input type="hidden" name="workingTime1" />
                              <input type="hidden" name="workingTime2" />
                           </td>
                        </tr>
                     </tbody>
                     </table>
                  ...
                  <div  class="signTable4" id="signTable4">
                     ...
                     <div class="signPage">
                        ...
                        <button type="submit" id="signNext3">회원가입</button>
                     </div>
                  </div>
               </div>
            </form>
...
$(function(){
   ...
   $("#signNext1").click(function(){
      ...
      if(page1Id && page1Pw1 && page1Pw2 && page1Email && page1Name){
         ...
         $("#progress>div:first-of-type").css("width","50%");
         $("#context>div").fadeOut(500);
         setTimeout(function() { 
            $("#progress>div:nth-of-type(3)").addClass("goSign");
   ...
   $("#signPrew2").click(function(){
      $("#progress>div:first-of-type").css("width","0%");
      $("#progress>div:nth-of-type(3)").removeClass("goSign");
      $("#context>div").fadeOut(500);
      setTimeout(function() { 
   ...
   $("#signNext2").click(function(){
      ...
      $("#progress>div:first-of-type").css("width","100%");
      $("#context>div").fadeOut(500);
      setTimeout(function() { 
         $("#progress>div:nth-of-type(4)").addClass("goSign");
   ...
   $("#signPrew3").click(function(){
      $("#progress>div:first-of-type").css("width","50%");
      $("#progress>div:nth-of-type(4)").removeClass("goSign");
      $("#context>div").fadeOut(500);
      setTimeout(function() { 
         $("#signTable2").fadeIn(500);
      }, 500);
   ...
   $("#signNext3").click(function signGo(){
