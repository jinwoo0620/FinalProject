            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                         ...
                         <input class="form-control" type="text" size="78" name="noticeTitle" value="${ notice.noticeTitle }">
                        
                       
                        
                    </div>
                    <div class="card-body">
                        <textarea class="form-control" rows="4" cols="80" name="noticeContent" style="resize: none;">${ notice.noticeContent }</textarea>
                    </div>
                    <div>
