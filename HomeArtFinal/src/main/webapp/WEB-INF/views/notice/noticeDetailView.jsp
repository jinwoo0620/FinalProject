...
<div class="pc-container">
    <div class="pcoded-content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
							...
							<input type="hidden" value="${ notice.noticeTitle }" name="noticeTitle">
                        ...
                        <c:if test="${ loginUser.id eq notice.writer }">
	                       <div align ="right">
		                        ...
		                        <button style="color: white" id = "button" type="button" class="btn" onclick="location.href='${ ndelete }'">삭제</button>
	                    ...
	                    <div class="card-body">
							...
							<div>
								...
								<input type="hidden" value="${ notice.noticeContent }" name="noticeContent">
							</div>
                  	  </div>
                 </div>
       ...
       <div class="col-sm-12" >
        <div class="card">
             <div class="card-header">
                        <h5>댓글<input type="text" class="form-control" id="replyContent"></h5>
                        <br>
        ...
        <script>
        	 $('#rSubmit').click(function(){
        		...
        		var refNId = ${notice.noticeNo};
        		
        		
        		$.ajax({
        			url: 'addReply.no',
        			data: {replyContent:rContent, boardNo:refNId},
        		...
        		$.ajax({
        			...
        			success: function(data){
        				...
        				if(data.length > 0){
        					for(var i in data){
        						$tr = $('<tr>');
        						$memberId = $('<td>').css('width', '100px').text(data[i].memberId);
        						$content = $('<td>').text(data[i].replyContent);
        						$date = $('<td width="100px">').text(data[i].createDate);
