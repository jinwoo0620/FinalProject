...
<div class="pc-container">
    <div class="pcoded-content">
        ...
        <div class="row">
            <!-- [ sample-page ] start -->
      <form action="nupdate4.no" method="post">
		<table id="boardInsertTable" border="1">  
            <div class="col-sm-12">
                <div class="card"> 
                    <div class="card-header">
                    	 <input type="hidden" name="page" value="${ page }">
                    	 <input type="hidden" name="noticeNo4" value="${ notice4.noticeNo4 }">
                         <input class="form-control" type="text" size="78" name="noticeTitle4" value="${ notice4.noticeTitle4 }">
                        
                       
                        
                    </div>
                    <div class="card-body">
                        <textarea class="form-control" rows="4" cols="80" name="noticeContent4" style="resize: none;">${ notice4.noticeContent4 }</textarea>
                    </div>
                    <div>
                    	<input class="form-control" type="hidden" name="writer4" readonly value="${ loginUser.id }">
                    </div>
