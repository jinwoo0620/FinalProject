...
<div class="pc-container">
    <div class="pcoded-content">
        ...
        <div class="row">
            <!-- [ sample-page ] start -->
      <form action="nupdate3.no" method="post">
		<table id="boardInsertTable" border="1">  
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                    	 <input type="hidden" name="page" value="${ page }">
                    	 <input type="hidden" name="noticeNo3" value="${ notice3.noticeNo3 }">
                         <input class="form-control" type="text" size="78" name="noticeTitle3" value="${ notice3.noticeTitle3 }">
                        
                       
                        
                    </div>
                    <div class="card-body">
                        <textarea class="form-control" rows="4" cols="80" name="noticeContent3" style="resize: none;">${ notice3.noticeContent3 }</textarea>
                    </div>
                    <div>
                    	<input class="form-control" type="hidden" name="writer3" readonly value="${ loginUser.id }">
                    </div>
