...
<div class="pc-container">
    <div class="pcoded-content">
        ...
        <div class="row">
            <!-- [ sample-page ] start -->
      <form action="ninsert4.no" method="post">
		<table id="boardInsertTable" border="1">  
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                         <input class="form-control" type="text" size="78" name="noticeTitle4" placeholder="제목을 입력하세요.">
                        
                       
                        
                    </div>
                    <div class="card-body">
                        <textarea class="form-control" rows="4" cols="80" name="noticeContent4" style="resize: none;" placeholder="내용을 입력하세요."></textarea>
                    </div>
                    <div>
