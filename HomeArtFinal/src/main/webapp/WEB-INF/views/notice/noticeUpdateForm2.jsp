...
<div class="pc-container">
    <div class="pcoded-content">
        ...
        <div class="row">
            <!-- [ sample-page ] start -->
      <form action="nupdate2.no" method="post">
		<table id="boardInsertTable" border="1">  
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                    	 <input type="hidden" name="page" value="${ page }">
                    	 <input type="hidden" name="noticeNo2" value="${ notice2.noticeNo2 }">
                         <input class="form-control" type="text" size="78" name="noticeTitle2" value="${ notice2.noticeTitle2 }">
                        
                       
                        
                    </div>
                    <div class="card-body">
                        <textarea class="form-control" rows="4" cols="80" name="noticeContent2" style="resize: none;">${ notice2.noticeContent2 }</textarea>
                    </div>
                    <div>
                    	<input class="form-control" type="hidden" name="writer2" readonly value="${ loginUser.id }">
                    </div>
