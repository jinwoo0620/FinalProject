	...
	<form action="einsert.ex" method="post" enctype="Multipart/form-data">
		<div class="profile">
			...
			<div class="my-profile">
				...
				<div class="info_3">
					<input type="text" name="expertTitle">
				</div>
			</div>
...
<!-- 						<span class="percentage-badge"></span> -->
			...
			<div class="my-profile">
				...
				<div class="info_1">
					<input type="checkbox" name="workingDay" value="월요일"><label>월</label>	&nbsp;
					<input type="checkbox" name="workingDay" value="화요일"><label>화</label>	&nbsp;
					<input type="checkbox" name="workingDay" value="수요일"><label>수</label>	&nbsp;	
					<input type="checkbox" name="workingDay" value="목요일"><label>목</label>	&nbsp;
					<input type="checkbox" name="workingDay" value="금요일"><label>금</label>	&nbsp;
					<input type="checkbox" name="workingDay" value="토요일"><label>토</label>	&nbsp;
					<input type="checkbox" name="workingDay" value="일요일"><label>일</label>
				</div>
			</div>
			...
			<div class="my-profile">
				...
				<div class="info_1">
					<input type="time" name="workingTime" style="width: 110px;">~<input type="time" name="workingTime" style="width: 110px;">
				</div>
			</div>
...
<!-- 						</div> -->
				...
				<div class="info">
					<input type="checkbox" name="field" value="이사/입주청소"><label>이사/입주청소</label>	&nbsp;
					<input type="checkbox" name="field" value="타일시공"><label>타일시공</label>	&nbsp;
					<input type="checkbox" name="field" value="도배/장판 "><label>도배/장판</label>	&nbsp;
					<input type="checkbox" name="field" value="에어컨 설치/수리"><label>에어컨 설치/수리</label>	&nbsp;
					<input type="checkbox" name="field" value="실내 인테리어"><label>실내 인테리어</label>
				</div>
			</div>
