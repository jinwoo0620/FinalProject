...
<body>
	...
	<section class="single-course spad pb-0">
		<div class="container">
			...
			<form action="communityInsert.bo" method="post" enctype="Multipart/form-data">
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						...
						<div id="course-title">
							...
							<input type="text" name="boardTitle" id="course-input" placeholder="제목을 입력하세요." required="required">
						</div>
						<div class="course-img">
							<label for="uploadFile1" id="inputLabel1">사진을 첨부하려면 클릭하세요</label>
							<input type="file" name="uploadFile1" id="uploadFile1" style="display:none" accept="image/*" required="required">
							<div id="preview1"></div>
						</div>
						<div class="course-img">
							<label for="uploadFile2" id="inputLabel2">사진을 첨부하려면 클릭하세요</label>
							<input type="file" name="uploadFile2" id="uploadFile2" style="display:none" accept="image/*" required="required">
							<div id="preview2"></div>
						</div>
						<div class="contact-form-warp">
							<textarea id="course-textarea" name="boardContent" placeholder="내용을 입력하세요." required="required"></textarea>
						</div>
						<div class="community_btn">
							<input type="submit" value="등록" id="submitBtn" class="site-btn buy-btn">
							<a href="communityList.bo" class="site-btn price-btn">취소</a>
							<br>
						</div>
					</div>
				</div>
		...
		$(document).ready(function (e){
			...
			function checkExtension(fileName,fileSize){
				...
				if(regex.test(fileName)){
					...
					$("#uploadFile1").val("");  //파일 초기화
					$("#uploadFile1").append("<label for='uploadFile1' id='inputLabel1'>사진을 첨부하려면 클릭하세요</label>");
					return false;
				}
				return true;
			}
			...
			function delImg(_this){
				$(_this).parent().parent().parent().find('div').remove()
			}
		});
	</script>
	<script type="text/javascript">
